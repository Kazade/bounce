...
void b3ClothSphereAndShapeContact::Update()
{
	m_active = false;
...
void b3ClothSphereAndShapeContactWorldPoint::Initialize(const b3ClothSphereAndShapeContact* c, scalar rA, const b3Vec3& cA, scalar rB)
{
